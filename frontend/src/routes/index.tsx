...
function Home() {
  ...
  const getStat = (key: string): string => {
    ...
    if (stat?.value === undefined || stat?.value === null) return '...';
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <span className='text-sm text-gray-700 dark:text-slate-300'>
                      ...
                      <span className='text-green-700 dark:text-green-400 font-medium'>
                        Valid
                        {data.systemHealth.authentication
                          .cookiesExpireInDays !== null &&
                  ...
                  return (
                    <div key={api.apiName} className='flex items-center gap-2'>
                      ...
                      <span className='text-sm text-gray-700 dark:text-slate-300'>
                        ...
                        <span className='text-gray-500 dark:text-slate-400 ml-1 text-xs'>
                          ({api.requestCount} req, max{' '}
                          {api.maxRequestsPerSecond}
                          /s)
                        </span>
                      </span>
                    </div>
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      <span className='text-red-700 dark:text-red-400 font-medium'>
                        Critical (
                        {data.systemHealth.storage.availableGb?.toFixed(1)}GB
                        free)
                      </span>
                    </span>
                  </>
                  ...
                  <>
                    ...
                    >
                      ...
                      <span className='text-yellow-700 dark:text-yellow-400 font-medium'>
                        Low ({data.systemHealth.storage.availableGb?.toFixed(1)}
                        GB free)
                      </span>
                    </span>
                  </>
                  ...
                  <>
                    ...
                    >
                      Storage:{' '}
                      <span className='text-green-700 dark:text-green-400 font-medium'>
                        {data?.systemHealth.storage.availableGb?.toFixed(0)}GB
                        free
                      </span>
                    </span>
                  </>
        ...
        {[
          {
            ...
            stat: 'tracked_artists',
          },
          {
            to: '/songs' as const,
            label: 'Downloaded Songs',
            stat: 'downloaded_songs',
          },
          {
            to: '/playlists' as const,
            label: 'Playlists',
            stat: 'total_playlists',
          },
          {
            to: '/dashboard' as const,
            label: 'Completion',
            stat: 'song_completion_pct',
            suffix: '%',
          },
        ].map(card => (
          <Link
            ...
            to={card.to}
            search={{}}
            className='bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-5 hover:shadow-md hover:border-[var(--color-accent)] transition-all'
          >
