...
export type GetLibraryStatsQuery = { __typename?: 'Query', libraryStats: { __typename?: 'LibraryStats', totalSongs: number, downloadedSongs: number, missingSongs: number, failedSongs: number, unavailableSongs: number, totalAlbums: number, downloadedAlbums: number, partialAlbums: number, missingAlbums: number, totalArtists: number, trackedArtists: number, songCompletionPercentage: number, albumCompletionPercentage: number, desiredSongs: number, desiredDownloaded: number, desiredCompletionPercentage: number } };
