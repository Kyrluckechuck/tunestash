...
export type SavePlaylistMutation = { __typename?: 'Mutation', savePlaylist: { __typename?: 'Playlist', id: number, name: string, url: string, enabled: boolean, autoTrackArtists: boolean, lastSyncedAt: string | null } };
