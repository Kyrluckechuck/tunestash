...
export type GetPlaylistsQuery = { __typename?: 'Query', playlists: { __typename?: 'PlaylistConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null }, edges: Array<{ __typename?: 'Playlist', id: number, name: string, url: string, status: string, statusMessage: string | null, enabled: boolean, autoTrackArtists: boolean, lastSyncedAt: string | null, provider: string }> } };
