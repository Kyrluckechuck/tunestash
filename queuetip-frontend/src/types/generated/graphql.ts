...
export type MutationExportToSpotifyArgs = {
...
export type SpotifyExportResultType = {
  __typename?: 'SpotifyExportResultType';
  addedCount: Scalars['Int']['output'];
  createdNew: Scalars['Boolean']['output'];
  skippedCount: Scalars['Int']['output'];
...
export type CreateExportMutation = { __typename?: 'Mutation', createExport: { __typename?: 'ExportSnapshotType', id: string, warningMessage: string } };
...
export type ExportQuery = { __typename?: 'Query', export: { __typename?: 'ExportSnapshotType', id: string, createdAt: any, parameters: string, rngSeed: string, warningMessage: string, requestedBy: { __typename?: 'AccountType', id: string, displayName: string }, playlist: { __typename?: 'PlaylistType', id: string, name: string, description: string }, tracks: Array<{ __typename?: 'ExportSnapshotTrackType', id: string, position: number, inclusionReason: string, rollProbability: number, song: { __typename?: 'SongRef', id: string, title: string, artist: string, isrc?: string | null } }> } };
...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'AccountType', id: string, displayName: string, createdAt: any, externalServices: Array<{ __typename?: 'ExternalServiceLinkType', service: string, serviceUserId: string, linkedAt: any }> } | null };
...
export type ExportToSpotifyMutationVariables = Exact<{
  snapshotId: Scalars['ID']['input'];
  playlistName?: InputMaybe<Scalars['String']['input']>;
  forceRecreate?: Scalars['Boolean']['input'];
}>;
