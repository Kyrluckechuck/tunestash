...
export type ExportToSpotifyMutation = { __typename?: 'Mutation', exportToSpotify: { __typename?: 'SpotifyExportResultType', spotifyPlaylistUrl: string, addedCount: number, skippedCount: number, skippedTitles: Array<string> } };
